...
public class GeomesaData_2 implements Runnable {
    private final Map<String, String> params;
    private final TutorialData data;
    private final boolean cleanup;
    private final boolean readOnly;

    public GeomesaData_2(String[] args, Param[] parameters, TutorialData data) throws ParseException {
        this(args, parameters, data, false);
    }

    public GeomesaData_2(String[] args, Param[] parameters, TutorialData data, boolean readOnly) throws ParseException {
